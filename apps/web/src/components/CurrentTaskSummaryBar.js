...
export const CurrentTaskSummaryBar = ({ taskId, taskSummary }) => {
    ...
    if (warningGroups.authenticityDowngrade.length) {
        warningPanels.push({
            ...
            label: (_jsx(Text, { strong: true, style: { color: '#ad6800' }, children: "\u771F\u5B9E\u6027\u964D\u7EA7\u5DF2\u89E6\u53D1" })),
            children: (_jsx(Text, { className: "content-wrap-safe", children: warningGroups.authenticityDowngrade.join('；') })),
        });
    }
