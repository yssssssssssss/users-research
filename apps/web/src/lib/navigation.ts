...
export type TaskDetailSection =
  ...
  | typeof TASK_DETAIL_SECTION_RESULT
  | typeof TASK_DETAIL_SECTION_REPORT
  | typeof TASK_DETAIL_SECTION_OPS;

export const buildTaskDetailPath = (
  taskId: string,
  section: TaskDetailSection = TASK_DETAIL_SECTION_OVERVIEW,
) => `${TASK_DETAIL_ROOT_PATH}/${encodeURIComponent(taskId)}/${section}`;
...
export const TASK_DETAIL_VISION_PATH = (taskId: string) =>
  buildTaskDetailPath(taskId, TASK_DETAIL_SECTION_VISION);
export const TASK_DETAIL_PERSONA_PATH = (taskId: string) =>
  buildTaskDetailPath(taskId, TASK_DETAIL_SECTION_PERSONA);
export const TASK_DETAIL_RESULT_PATH = (taskId: string) =>
  buildTaskDetailPath(taskId, TASK_DETAIL_SECTION_RESULT);
export const TASK_DETAIL_REPORT_PATH = (taskId: string) =>
  buildTaskDetailPath(taskId, TASK_DETAIL_SECTION_REPORT);
export const TASK_DETAIL_OPS_PATH = (taskId: string) =>
  buildTaskDetailPath(taskId, TASK_DETAIL_SECTION_OPS);
...
export const getPrimaryNavKey = (pathname: string) => {
...
export const isTaskDetailPath = (pathname: string) => {
...
export const getTaskDetailTabKey = (pathname: string) => {
  ...
  if (section === TASK_DETAIL_SECTION_RESULT) return TASK_DETAIL_SECTION_RESULT;
  if (section === TASK_DETAIL_SECTION_REPORT) return TASK_DETAIL_SECTION_REPORT;
  if (section === TASK_DETAIL_SECTION_OPS) return TASK_DETAIL_SECTION_OPS;
